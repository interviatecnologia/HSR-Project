...
if ($json_data !== '') {
    ...
    $allowed_variables = array('source', 'user', 'agent_pass','pass', 'agent_user', 'value', 'list_id', 'first_name','last_name', 'phone_number','phone_code','search','preview','dnc_check','focus');
    ...
    echo "search: " . ($search ? 'sim' : 'não') . "\n";
    echo "preview: " . ($preview ? 'sim' : 'não') . "\n";
    echo "dnc_check: " . ($dnc_check ? 'sim' : 'não') . "\n";
    echo "focus: " . ($focus ? 'sim' : 'não') . "\n";

    ## add more variables as needed

	## now you can use the applications
